...
export const PERMISSIONS_MATRIX: PermissionMatrix = {
    ...
    '/worship/calendar': ['superadmin', 'pastor', 'leader', 'coordinator', 'member', 'ujier'],

    // MainHub (Pastoral/Admin)
    '/mainhub': ['superadmin', 'pastor', 'leader', 'coordinator'],
    '/mainhub/people': ['superadmin', 'pastor', 'leader'],
    '/mainhub/people/approvals': ['superadmin', 'pastor'],
    '/mainhub/people/invite': ['superadmin', 'pastor', 'leader', 'coordinator'],
    '/mainhub/teams': ['superadmin', 'pastor', 'leader'],
    '/mainhub/my-team': ['superadmin', 'leader', 'coordinator', 'member'],
    ...
    '/mainhub/pastor': ['pastor', 'superadmin'],
    '/mainhub/churches': ['superadmin'],
    '/mainhub/churches/edit': ['superadmin', 'pastor'],
    '/mainhub/areas': ['superadmin', 'pastor', 'leader'],
    ...
    'action.church.update_own': ['superadmin', 'pastor'],
    'action.users.manage': ['superadmin', 'pastor'],
    'action.users.view': ['superadmin', 'pastor', 'leader', 'coordinator'],
    'action.team.delete': ['superadmin', 'pastor', 'leader'],
    'action.chatbot': ['superadmin', 'pastor', 'leader'],
};
