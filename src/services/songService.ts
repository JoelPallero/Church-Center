...
// In-memory/LocalStorage cache for mock/fallback mode
// Removed mock logic to prevent inconsistent "ghost" edits
...
const MOCK_SONGS: Song[] = [
    {
        id: 9999,
        churchId: 1,
        title: 'Tu Presencia (Ficticia)',
        artist: 'Banda MSM',
        originalKey: 'G',
        tempo: 78,
        timeSignature: '4/4',
        content: '[G]En tu pres[D]encia[Em]\nhay plen[C]itud de gozo\n[G]En tu pres[D]encia[Em]\nme des[C]lizo en tu amor',
        category: 'worship',
        bpmType: 'slow'
    }
];
