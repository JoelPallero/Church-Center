...
export const BottomNav: FC = () => {
    ...
    if (isMaster) {
        ...
        navItems = [
            ...
            { path: '/churches', icon: 'church', label: 'Iglesias'},
        ...
        // First item Reportes -> /
        navItems = [
            { path: '/', icon: 'analytics', label: 'Reportes' },
            { path: '/dashboard_view', icon: 'dashboard', label: 'Dashboard' },
            { path: '/reunions', icon: 'event', label: 'Eventos', isCentral: true },
            { path: '/churches', icon: 'location_city', label: 'Areas' },
        ...
        navItems = [
            ...
            { path: '/teams', icon: 'groups', label: 'Equipo' },
            { path: '/playlists', icon: 'reorder', label: 'Listados', isCentral: true },
            { path: '/songs', icon: 'music_note', label: 'Canciones' },
            { path: '/reunions', icon: 'event', label: 'Calendario' }
        ];
    } else if (isMember) {
        // Miembros: Listados, Canciones, Calendario
        // First item Listados -> /
        navItems = [
            { path: '/', icon: 'reorder', label: 'Listados' },
            { path: '/songs', icon: 'music_note', label: 'Canciones', isCentral: true },
            { path: '/reunions', icon: 'event', label: 'Calendario' }
        ];
    } else if (isGuest) {
